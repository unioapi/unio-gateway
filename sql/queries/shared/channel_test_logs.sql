...
INSERT INTO channel_test_logs (
    ...
    sqlc.narg(tested_origin_revision), sqlc.narg(tested_status_revision), sqlc.narg(tested_config_revision), sqlc.arg(state_change_applied)
);
...
SELECT
    ...
    sqlc.arg(tested_origin_revision), sqlc.arg(tested_status_revision),
