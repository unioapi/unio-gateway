...
func TestDeepSeekAnthropicBlackboxNonStream(t *testing.T) {
	...
	resp, err := a.Messages(context.Background(), runtime, messagesadapter.MessageRequest{
...
func TestDeepSeekAnthropicBlackboxStream(t *testing.T) {
	...
	var types []string
	var finalUsage *messagesadapter.MessageUsage
	outcome, err := a.StreamMessages(context.Background(), runtime, messagesadapter.MessageRequest{
		Model:     "deepseek-v4-flash",
		MaxTokens: intPtr(32),
		Messages: []messagesadapter.Message{
...
func TestDeepSeekAnthropicBlackboxImageRejectedPreflight(t *testing.T) {
	...
	_, err := a.Messages(context.Background(), runtime, messagesadapter.MessageRequest{
		Model:     "deepseek-v4-flash",
		MaxTokens: intPtr(16),
		Messages: []messagesadapter.Message{
