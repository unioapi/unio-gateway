...
type capabilityProbe struct {
	key    capability.Key
	apply  func(*anthropicadapter.MessageRequest)
	verify func(t *testing.T, cleaned anthropicadapter.MessageRequest) probeOutcome
}
	...
	return []capabilityProbe{
		{
			...
			apply: func(r *anthropicadapter.MessageRequest) {
				r.Tools = json.RawMessage(`[{"name":"get_weather","input_schema":{"type":"object"}}]`)
			},
			verify: func(t *testing.T, c anthropicadapter.MessageRequest) probeOutcome {
		...
		},
		{
			...
			apply: func(r *anthropicadapter.MessageRequest) {
				r.Messages = []anthropicadapter.Message{
...
func contentBlockOutcome(t *testing.T, c anthropicadapter.MessageRequest, blockType string) probeOutcome {
	t.Helper()
...
func outputConfig(t *testing.T, c anthropicadapter.MessageRequest) (map[string]any, bool) {
	t.Helper()
...
func extensionPresent(c anthropicadapter.MessageRequest, key string) bool {
