...
func TestGetRequestRoutingDecisionAndAuth(t *testing.T) {
	...
	svc := &fakeRoutingTraceService{getOut: routingtrace.Decision{
		ID: 9, RequestID: "req/with-space", RouteID: 2, TraceStatus: "complete", SchemaVersion: 1,
...
func TestGetRouteRuntime(t *testing.T) {
	...
	if !body.Data.RouteSummary.NoRedundancy || len(body.Data.Channels) != 1 || body.Data.Channels[0].Score.Total != 87.5 {
