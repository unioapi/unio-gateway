...
WITH updated AS (
    UPDATE request_records
        SET status = 'succeeded',
            ...
            final_provider_id = $4,
            final_channel_id = $5,
            final_provider_origin_id = (SELECT c.provider_origin_id FROM channels c WHERE c.id = $5),
