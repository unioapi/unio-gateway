...
| 任务 | 状态 | 说明 |
| --- | --- | --- |
| TASK-7.17 | in_progress | gateway request-level authorization、capture/release baseline、部分余额授权、平台差额核销和无 final usage 风险敞口记录已接入；[GAP-7-004](../../production/TODO_REGISTER.md#gap-7-004)、[GAP-7-014](../../production/TODO_REGISTER.md#gap-7-014) 已关闭。prompt token 仍为临时估算，关联 [GAP-7-013](../../production/TODO_REGISTER.md#gap-7-013)。 |
