...
CREATE TABLE public.channel_test_logs (
    ...
    CONSTRAINT channel_test_logs_tested_origin_revision_check CHECK (((tested_origin_revision IS NULL) OR (tested_origin_revision >= 1))),
    CONSTRAINT channel_test_logs_tested_status_revision_check CHECK (((tested_status_revision IS NULL) OR (tested_status_revision >= 1))),
